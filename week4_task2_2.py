...
def stabilize(input_video_path: str, output_video_path: str, kp_detector: str = 'GFTT', **kp_kwargs):
    ...
    print(f' kp_detector {kp_detector} with args {kp_kwargs}')
...
def task_2_2():
    ...
    for kp_detector, kp_kwargs in params:
        ...
        stabilize(input_video_path=str(INPUT_VIDEO_PATH), output_video_path=str(output_video_path), kp_detector=kp_detector, **kp_kwargs)
